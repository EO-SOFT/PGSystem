...
public class PACKAGING_WAREHOUSE_UI0002_STOCK extends javax.swing.JDialog {
    ...
    public void reload_result_table_data(List<Object[]> resultList) {
        ...
        packaging_stock_table.setModel(new DefaultTableModel(packaging_stock_result_table_data, packaging_stock_result_table_header));
        packaging_stock_table.setFont(new Font(String.valueOf(Helper.PROP.getProperty("JTABLE_FONT")), Font.BOLD, Integer.valueOf(Helper.PROP.getProperty("JTABLE_FONTSIZE"))));
        packaging_stock_table.setRowHeight(Integer.valueOf(Helper.PROP.getProperty("JTABLE_ROW_HEIGHT")));
    }
    ...
    public void refresh() {
        ...
        try {
            ...
            String query_str = "SELECT "
                    ...
                    + "AND p.warehouse = '"+Helper.PROP.getProperty("WH_PACKAGING")+"' "
