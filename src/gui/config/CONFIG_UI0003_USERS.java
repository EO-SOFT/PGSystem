...
public class CONFIG_UI0003_USERS extends javax.swing.JDialog {
    ...
    private void initContainerTableDoubleClick() {
        this.users_table.addMouseListener(
                new MouseAdapter() {
                    public void mouseClicked(MouseEvent e) {
                        if (e.getClickCount() == 2) {
                            ...
                            u = (ManufactureUsers) query.list().get(0);
                            id_lbl.setText(u.getId().toString());
                            fname_txtbox.setText(u.getFirstName());
                            lname_txtbox.setText(u.getLastName());
                            login_txtbox.setText(u.getLogin());
                            pwd_txtbox.setText(u.getPassword());
    ...
    private void initComponents() {
        ...
        jPanel1Layout.setVerticalGroup(
            ...
            .addGroup(jPanel1Layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addComponent(id_lbl, javax.swing.GroupLayout.Alignment.CENTER, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
            ...
            .addGroup(user_list_panelLayout.createSequentialGroup()
                ...
                .addGroup(user_list_panelLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, user_list_panelLayout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(login_txtbox_search, javax.swing.GroupLayout.PREFERRED_SIZE, 63, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
    ...
    private void save_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_save_btnActionPerformed
        if (lname_txtbox.getText().isEmpty() || fname_txtbox.getText().isEmpty() || login_txtbox.getText().isEmpty() || pwd_txtbox.getText().isEmpty()) {
        ...
        } else if (isLoginExist(login_txtbox.getText().trim()) != 0) { //true = exist !
            ...
            if (id_lbl.getText().isEmpty()) { // ID Label is empty, then is a new User
                ...
                u.setFirstName(fname_txtbox.getText());
                u.setLastName(lname_txtbox.getText());
                u.setActive(Integer.valueOf(active_combobox.getSelectedItem().toString()));
                u.setAccessLevel(Integer.valueOf(level_combobox.getSelectedItem().toString()));
                u.setLogin(login_txtbox.getText());
                u.setPassword(pwd_txtbox.getText());
                u.setWriteId(Helper.context.getUser().getId());
