...
public class PACKAGING_UI0002_PasswordRequest extends javax.swing.JDialog {
    ...
    public void loadPartNumberCodePatterns(String customer) {
        ...
        System.out.println(Helper.PARTNUMBER_PATTERN_LIST.length+" part number pattern for customer '"+customer+"' successfuly loaded 100% ! ");
        
    }
    
    private void connect() {
        Helper.Packaging_Gui.enableAdminMenus();
        ...
        Helper.Packaging_Gui.setUserLabelText(
                Helper.context.getUser().getFirstName() + " "
                + Helper.context.getUser().getLastName() + " "
                + "[" + Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString() + "]"
        );
        //Disable filter
        Helper.Packaging_Gui.setHarnessTypeFilterBoxState(false);
        
        //Load DOTMATRIX
        loadDotMatrixCodePatterns(Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString());
        
        //Load PART NUMBER patterns
        loadPartNumberCodePatterns(Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString());
