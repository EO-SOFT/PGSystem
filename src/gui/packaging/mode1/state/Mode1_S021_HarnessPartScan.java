...
public class Mode1_S021_HarnessPartScan implements Mode1_State {
    ...
    public Mode1_S021_HarnessPartScan() {
        ...
        Helper.mode2_context.getBaseContainerTmp().setHarnessType(String.valueOf(Helper.Packaging_Gui_Mode1.getHarnessTypeBox().getSelectedItem()));
    }
