    ...
    public void doAction(Context context) {
        ...
        if (!barcode.isEmpty()) {
            ...
            if (barcode.equals(Helper.OPEN_PALLET_KEYWORD)) {//NEWP barcode
                ...
                if (Helper.context.getBaseContainerTmp().getHarnessPart().startsWith(Helper.HARN_PART_PREFIX)) {
            ...
            //# 5- Container Harness Type = Context Harness Type
                    ...
                    ||
                    bc.getHarnessPart().equals(Helper.context.getBaseContainerTmp().getHarnessPart())
                    )
