...
import gui.packaging.state.S050_ClosingPallet;
...
public final class PACKAGING_UI0010_PalletDetails extends javax.swing.JDialog {
    ...
    public PACKAGING_UI0010_PalletDetails(java.awt.Frame parent, boolean modal,
        ...
        if (state_txtbox.getText().equals(Helper.PALLET_WAITING) && Helper.context.getUser() != null) {
        ...
        if (state_txtbox.getText().equals(Helper.PALLET_OPEN) && Helper.context.getUser() != null) {
    ...
    private void searchForPallet(String palletNumber) {
        ...
        if (!palletNumber.trim().equals("")) {
            if(palletNumber.startsWith(Helper.CLOSE_PAL_PREF))
    ...
    private void dropButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_dropButtonActionPerformed
        if (!palletId_txtbox.getText().equals("")) {
            PACKAGING_UI9001_DropContainerConfirmation dropConfirm = new PACKAGING_UI9001_DropContainerConfirmation(this, rootPaneCheckingEnabled, this.bc);
    ...
    private void continue_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_continue_btnActionPerformed
        ...
        Helper.context.getBaseContainerTmp().setPalletNumber(bc.getPalletNumber());
        //Set requested closing pallet number in the main gui
        Helper.Packaging_Gui.setRequestedPallet_txt("N° " + Helper.CLOSE_PAL_PREF + bc.getPalletNumber());
        //############# PASSE TO S050 STATE ###############
        Helper.Packaging_Gui.state = new S050_ClosingPallet();
        this.dispose();
