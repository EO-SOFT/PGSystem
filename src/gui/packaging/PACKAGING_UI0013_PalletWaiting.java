...
public class PACKAGING_UI0013_PalletWaiting extends javax.swing.JDialog {
    ...
    public PACKAGING_UI0013_PalletWaiting(java.awt.Frame parent, boolean modal) {
        ...
        if (Helper.context.getBaseContainerTmp().getHarnessType() == null) {
            loadContainer("ALL");
            continue_btn.setVisible(false);
        } else {
            loadContainer(Helper.context.getBaseContainerTmp().getHarnessType());
        }
    ...
    public void setContainerTableRowsStyle() {
        ...
        //#######################
        container_table.setFont(new Font(String.valueOf(Helper.PROP.getProperty("JTABLE_FONT")), Font.BOLD, 14));
