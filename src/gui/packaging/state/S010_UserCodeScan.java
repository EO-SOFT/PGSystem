...
import gui.packaging.PACKAGING_UI0002_PasswordRequest;
...
public class S010_UserCodeScan implements State {
    ...
    public void doAction(Context context) {
        ...
        //String harnessType = String.valueOf(Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem());        
        ...
        if (!scan_txtbox.getText().trim().equals("")) {
            ...
            switch (result.size()) {
                ...
                case 1:
                    ...
                    //Disable Project Box
                    Helper.Packaging_Gui.setHarnessTypeBoxState(false);
                    break;
