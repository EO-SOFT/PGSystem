 ...
 * @author ezou1001
 */
public class S032_EngineLabel2Scan implements State {

    private ImageIcon imgIcon = new ImageIcon(Helper.PROP.getProperty("IMG_PATH") + "S031_EngineLabel2Scan.jpg");

    public S032_EngineLabel2Scan() {
    ...
    public void doAction(Context context) {
        ...
        if (!bel.checkLabelFormat(engineLabel)) {//Problème de format
        ...
        } else if (bel.isLabelCodeExist(engineLabel) || engineLabel.equals(Helper.context.getBaseEngineLabelTmp().getLabelCode()[0])) {//Problème de doublant            
            ...
            Helper.context.getBaseEngineLabelTmp().setLabelCode(1, engineLabel);
            Helper.log.info("Second Valid Engine Label scanned [" + engineLabel + "] OK.");
            //Vide le scan box
            this.clearScanBox(scan_txtbox);
