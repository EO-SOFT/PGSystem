...
public class S020_HarnessPartScan implements State {
    ...
    public S020_HarnessPartScan() {
        ...
        Helper.context.getBaseContainerTmp().setHarnessType(String.valueOf(Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem()));
    }
    ...
    public void doAction(Context context) {
        ...
        else if (!ConfigUcs.isHarnessPartExist(harnessPart, Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString())) {
            Helper.log.warning(String.format(Helper.ERR0016_HP_NOT_FOUND_IN_UCS_HARNESS_TYPE, harnessPart, Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString()));
            JOptionPane.showMessageDialog(
                    null,
                    String.format(Helper.ERR0016_HP_NOT_FOUND_IN_UCS_HARNESS_TYPE, harnessPart, Helper.Packaging_Gui.getHarnessTypeBox().getSelectedItem().toString()), "Invalid Harness Part format !", JOptionPane.ERROR_MESSAGE);
