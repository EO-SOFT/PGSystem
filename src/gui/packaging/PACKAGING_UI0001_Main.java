 ...
 * @author user
 */
public final class PACKAGING_UI0001_Main extends javax.swing.JFrame {
     ...
     * @param context
     */
    public PACKAGING_UI0001_Main(Object[] context, JFrame parent) {
        initComponents();
    ...
    public void logout() {
        ...
        Helper.Packaging_Gui.setHarnessTypeFilterBoxState(true);
        disableAdminMenus();
