 ...
 * @author user
 */
public class WAREHOUSE_DISPATCH_UI0003_PasswordRequest extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WAREHOUSE_DISPATCH_UI0003_PasswordRequest(Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void connect() {
        ...
        WarehouseHelper.warehouse_out_context.setUser(this.user);
...
//        his_login.create(his_login);
        ...
        WarehouseHelper.warehouse_out_context.setState(new S020_PalletNumberScan());
