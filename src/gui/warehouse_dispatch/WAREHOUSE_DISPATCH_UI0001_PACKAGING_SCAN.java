...
import gui.packaging.PACKAGING_UI0014_PalletHistory;
 ...
 * @author user
 */
public class WAREHOUSE_DISPATCH_UI0001_PACKAGING_SCAN extends javax.swing.JDialog {
     ...
     * @param modal
     */
    public WAREHOUSE_DISPATCH_UI0001_PACKAGING_SCAN(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        this.setModal(modal);
        initComponents();
        initGui();
     ...
     */
    public WAREHOUSE_DISPATCH_UI0001_PACKAGING_SCAN(java.awt.Frame parent, boolean modal, String PalletNumber) {
        super(parent, modal);
        this.setModal(modal);
        initComponents();
        initGui();
    ...
    private void initComponents() {
        ...
        set_to_shipped_btn = new javax.swing.JButton();
        ...
        jLabel15.setText("Pack number to be shipped");

        set_to_shipped_btn.setBackground(new java.awt.Color(0, 102, 102));
        set_to_shipped_btn.setForeground(new java.awt.Color(255, 255, 255));
        set_to_shipped_btn.setIcon(new javax.swing.ImageIcon(getClass().getResource("/gui/apply.png"))); // NOI18N
        set_to_shipped_btn.setText("Set to shipped");
        set_to_shipped_btn.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                set_to_shipped_btnActionPerformed(evt);
            }
        });
                    ...
                    .addGroup(jPanel1Layout.createSequentialGroup()
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addComponent(set_to_shipped_btn)))
                        .addGap(34, 34, 34)
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                        ...
                        .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addGroup(jPanel1Layout.createSequentialGroup()
                                ...
                                .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                                    ...
                                    .addGroup(jPanel1Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                                        .addComponent(store_txt)
                                        .addComponent(set_to_shipped_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 28, javax.swing.GroupLayout.PREFERRED_SIZE)))))))
    ...
    public boolean updateStatus() {
        ...
        try {
            ...
            if (bc.checkContainerByState(store_txt.getText().substring(Helper.CLOSE_PAL_PREF.length()), Helper.PALLET_STORED)) {
                this.searchForPallet(store_txt.getText().substring(Helper.CLOSE_PAL_PREF.length()));
                System.out.println("Exist and closed. set to shipped ! " + store_txt.getText().substring(Helper.CLOSE_PAL_PREF.length()));

                Helper.sess.beginTransaction();
                Query query = Helper.sess.createQuery(HQLHelper.SET_CONTAINER_STATE_TO_SHIPPED);
                query.setParameter("palletNumber", store_txt.getText().substring(Helper.CLOSE_PAL_PREF.length()));
            ...
            //##########################################################
                ...
                showMsg("Pallet state should be STORED or incorrect number format !", -1);                
                return false;
            }
        } catch (Exception e) {            
    ...
    private void set_to_shipped_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_set_to_shipped_btnActionPerformed
       if(this.updateStatus()) store_txt.setText("");        
    }//GEN-LAST:event_set_to_shipped_btnActionPerformed
    ...
    private void search_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_search_btnActionPerformed
        if (!search_txtbox.getText().equals("")
            ...
            this.searchForPallet(search_txtbox.getText().substring(Helper.CLOSE_PAL_PREF.length()));
        } else {
    ...
    private javax.swing.JButton set_to_shipped_btn;
