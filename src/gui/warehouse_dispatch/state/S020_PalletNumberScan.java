 ...
 * @author user
 */
public class S020_PalletNumberScan implements State {

    public S020_PalletNumberScan() {
    }
...
//                        
                        ...
                        SoundHelper.PlayOkSound(null, 1);
                        WarehouseHelper.Dispatch_Gui.setMessageLabel("OK - Element ajouté", 1);
                    } catch (ParseException ex) {
                        Logger.getLogger(S020_PalletNumberScan.class.getName()).log(Level.SEVERE, null, ex);
                    }
                }
            }
        } else {
