 ...
 */
public class BaseEngineLabelTmp implements java.io.Serializable {
    ...
    public BaseEngineLabelTmp() {
    }

    public BaseEngineLabelTmp(String[] labelCode, BaseHarness harness, int harnessId) {
