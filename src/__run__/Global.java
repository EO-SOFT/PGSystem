...
public class Global {
     ...
     *
     */
    public static String APP_VERSION = "v18.01.09";
    ...
    /**
     * Global propeties of the application
     */
     ...
     *
     */
    public static String HARN_PART_PREFIX = Global.APP_PROP.getProperty("HARN_PART_PREFIX");

    /**
     *
     */
    public static String SUPPLIER_PART_PREFIX = Global.APP_PROP.getProperty("SUPPLIER_PART_PREFIX");

    /**
     *
     */
    public static String HARN_COUNTER_PREFIX = Global.APP_PROP.getProperty("HARN_COUNTER_PREFIX");

    /**
     *
     */
    public static String QUANTITY_PREFIX = Global.APP_PROP.getProperty("QUANTITY_PREFIX");

    /**
     *
     */
    public static String CLOSING_PALLET_PREFIX = Global.APP_PROP.getProperty("CLOSING_PALLET_PREFIX");

    /**
     *
     */
    public static String OPEN_PALLET_KEYWORD = Global.APP_PROP.getProperty("OPEN_PALLET_KEYWORD");
    
    public static void mapProperties() {
        OPEN_PALLET_KEYWORD = Global.APP_PROP.getProperty("OPEN_PALLET_KEYWORD");

        HARN_PART_PREFIX = Global.APP_PROP.getProperty("HARN_PART_PREFIX");

        SUPPLIER_PART_PREFIX = Global.APP_PROP.getProperty("SUPPLIER_PART_PREFIX");

        HARN_COUNTER_PREFIX = Global.APP_PROP.getProperty("HARN_COUNTER_PREFIX");

        QUANTITY_PREFIX = Global.APP_PROP.getProperty("QUANTITY_PREFIX");

        CLOSING_PALLET_PREFIX = Global.APP_PROP.getProperty("CLOSING_PALLET_PREFIX");
    }
    ...
    /**
     * true: Only one pack type can be opened in the actual workstation
     * (KLTV, HV, RV)
     *
     */
